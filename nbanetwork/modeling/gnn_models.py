...
#         self.conv2 = GATConv(hidden_channels * 4, hidden_channels * 2, heads=4, dropout=dropout)
#         self.bn2 = torch.nn.BatchNorm1d(hidden_channels * 2)
#         self.conv3 = GATConv(hidden_channels * 2, hidden_channels * 2, heads=4, dropout=dropout)
#         self.bn3 = torch.nn.BatchNorm1d(hidden_channels * 2)
#         self.dropout = dropout
#         self.fc = torch.nn.Sequential(
#             torch.nn.Linear(hidden_channels * 4, hidden_channels * 2),
